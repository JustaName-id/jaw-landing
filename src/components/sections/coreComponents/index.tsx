                    ...
                    >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
                            <Card
                                ...
                                description={"Using your device’s biometric security (Face ID, Touch ID)"}
                            />
                            <Card
                                className="col-span-1"
                    ...
                    >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
                            <Card
                                ...
                                description={"Through CREATE2 deployments for new accounts, using your passkey's public key and namehash as salt to generate the same pre-computed wallet address across all supported EVM chains"}
                            />
                            <Card
                                className="col-span-1"
                            ...
                            <div className="flex flex-col gap-2.5 p-5 bg-secondary rounded-[6px] col-span-1 md:col-span-2">
                                <p className="text-xl font-normal leading-[140%] text-black">EIP-7702 compatibility</p>
                                <p className="text-base font-normal leading-[150%] text-black">Enabling existing EOAs to leverage advanced account features through delegation</p>
                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
                        <Card
                            ...
                            icon={<Blocks color="black" />}
                            description={"With ERC-7739 nested EIP-712 support, eliminating signature replay attacks across accounts"}
                        />
                        <Card
                            className="col-span-1"
